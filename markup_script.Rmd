...
######## NR. 5   #########
  ...
  #xlim(6.3831, 2.583333) 
    ...
    #geom_point(data = venues_be , aes(x = venues_be$longitude, y = venues_be$latitude)) +
  #xlim(2.583333, 6.3831) +
  #ylim(49.5072, 51.4978) 
  #geom_point(aes(zu, 50.02708))
  #geom_point(aes(as.numeric(df_belgium1$longitude)), (df_belgium1$latitude))



#   print((geom_point(aes(x= df_belgium$longitude, y= df_belgium$latitude), colour="blue")) , + ) 
# }
