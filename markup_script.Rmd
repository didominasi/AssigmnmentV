...
Instead of creating my own "next_event" variable I could also use
...
geom_point(data= df_germany1, aes(x = as.numeric(longitude), y = as.numeric(latitude))) +
...
for (j in seq(0, total_number_pages_be)){
